...
Open an issue on our [issues list](https://git.sami.int.thomsonreuters.com/compass/cta-master/issues) on GitLab which describes the feature you would like to see, why you need it, and how it should work.
...
- test : the test directory contains all tests of the module : unit tests, functional tests, etc.
  - test/unit/lib/package/class.test.js : a unit test for class.js found under /lib/pachage
...
git checkout -b cta-fix-404-batman master
or
git checkout -b cta-new-42-robin master
...
5. Run the full grunt task and ensure that all tests pass.
